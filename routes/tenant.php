...
Route::middleware([
    ...
    Route::middleware(['auth:sanctum'])->group(function () {
        ...
        Route::prefix('exportExcell')->group(function () {
            ...
            Route::get('media-types', [MediaTypeController::class, 'exportExcell']);
        ...
        Route::prefix('exportPdf')->group(function () {
            ...
            Route::get('/media-types', [MediaTypeController::class, 'exportPdf']);
        ...
        Route::prefix('importFromExcel')->group(function () {
            ...
            Route::post('/countries/headers', [CountryController::class, 'importHeaders']);
            Route::post('/countries/dry-run', [CountryController::class, 'importDryRun']);
            Route::get('/countries/schema', [CountryController::class, 'importSchema']);
            ...
            Route::post('/media-types', [MediaTypeController::class, 'importFromExcel']);
