...
Route::apiResource('assignments', AssignmentController::class);
            ...
            Route::post('service-categories/export-excel', [ServiceCategoryController::class, 'exportExcell']);
            Route::post('service-categories/export-pdf', [ServiceCategoryController::class, 'exportPdf']);
            Route::post('service-categories/import-excel', [ServiceCategoryController::class, 'importFromExcel']);
