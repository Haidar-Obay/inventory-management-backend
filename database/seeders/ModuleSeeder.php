        ...
        $modules = [
            [
                ...
                'pages' => [
                    ...
                    ['name' => 'Customer Master Lists', 'code' => PageCode::CUSTOMERS_MASTER_LISTS->value, 'path' => '/main/mainfiles/customer?tab=4', 'order' => 15, 'is_public' => false],
                    ['name' => 'Customer Balance', 'code' => PageCode::CUSTOMERS_BALANCE->value, 'path' => '/main/mainfiles/customer?tab=3', 'order' => 16, 'is_public' => false],
            ...
            [
                ...
                'pages' => [
                    ...
                    ['name' => 'Supplier Balance', 'code' => PageCode::SUPPLIERS_BALANCE->value, 'path' => '/main/mainfiles/supplier?tab=2', 'order' => 21, 'is_public' => false],
                    ...
                    ['name' => 'Customer Master Lists', 'code' => PageCode::CUSTOMERS_MASTER_LISTS->value, 'path' => '/main/mainfiles/customer?tab=4', 'order' => 24, 'is_public' => false],
                    ['name' => 'Customer Balance', 'code' => PageCode::CUSTOMERS_BALANCE->value, 'path' => '/main/mainfiles/customer?tab=3', 'order' => 25, 'is_public' => false],
                    ['name' => 'User Management', 'code' => PageCode::USER_MANAGEMENT_PAGE->value, 'path' => '/main/settings/userManagement?tab=0', 'order' => 90, 'is_public' => false],
                    ['name' => 'Permission', 'code' => PageCode::PERMISSIONS_PAGE->value, 'path' => '/main/settings/userManagement?tab=1', 'order' => 91, 'is_public' => false],
                    ['name' => 'Role Management', 'code' => PageCode::ROLES_PAGE->value, 'path' => '/main/settings/userManagement?tab=2', 'order' => 92, 'is_public' => false],
                    ['name' => 'System Settings', 'code' => PageCode::SYSTEM_SETTINGS_PAGE->value, 'path' => '/main/settings/systemSettings', 'order' => 93, 'is_public' => false],
            ...
            [
                ...
                'pages' => [
                    ...
                    ['name' => 'Customer Master Lists', 'code' => PageCode::CUSTOMERS_MASTER_LISTS->value, 'path' => '/main/mainfiles/customer?tab=4', 'order' => 33, 'is_public' => false],
                    ['name' => 'Customer Balance', 'code' => PageCode::CUSTOMERS_BALANCE->value, 'path' => '/main/mainfiles/customer?tab=3', 'order' => 34, 'is_public' => false],
                    ...
                    ['name' => 'Supplier Balance', 'code' => PageCode::SUPPLIERS_BALANCE->value, 'path' => '/main/mainfiles/supplier?tab=2', 'order' => 42, 'is_public' => false],
